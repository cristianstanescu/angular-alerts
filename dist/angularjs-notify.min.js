 ...
 * @license MIT
 */
angular.module("angularjsNotify",[]).provider("Notify",function(){function e(e){var t=e.contexts,s=e.keysToSkip,n=[];this.displayTime=e.displayTime,this.addMessage=function(e,t){function i(e){return!e||s.indexOf(e.toLowerCase())>-1?"":e.replace(/_/g," ")+" "}function a(e,s){var a=(i(e)+s).trim();a=a.charAt(0).toUpperCase()+a.slice(1),n.push({context:t||"info",text:a,attribute:e}),n.length>=10&&(n=n.slice(0,10))}function o(e){angular.forEach(e,function(e,t,s){if(e instanceof Array)angular.forEach(e,function(e){a(t,e)});else{var n="string"==typeof t?t:null;a(n,e)}})}"string"==typeof e?a(null,e):o(e)},this.getMessages=function(){return n},this.removeFirstMessage=function(){n=n.slice(1)},this.removeMessage=function(e){n=n.filter(function(t){return t===e})},this.removeAllMessages=function(){n=[]},this.lastMessage=function(){return n.slice(-1)[0]},t.reduce(function(e,t){return e[t]=function(e){this.addMessage(e,t)},e},this)}var t={contexts:["danger","warning","info","success"],keysToSkip:["base","error"],displayTime:7e3};this.config=t,this.$get=function(){return new e(t)}}).directive("angularjsNotify",["Notify","$templateCache","$timeout",function(e,t,s){function n(t,n,i){function a(t){s(function(){e.removeMessage(t)},o)}var o=e.displayTime;t.$watch(e.getMessages,function(s,n){t.messages=s,s.length>n.length&&a(e.lastMessage())},!0),t.removeNotificationMessage=function(t){e.removeMessage(t)}}return{restrict:"EA",link:n,template:t.get("notifications.html"),scope:{}}}]),angular.module("angularjsNotify").run(["$templateCache",function(e){e.put("notifications.html",'<div class="alert alert-{{ message.context }} alert-dismissible fade in animate-hide" message="message" ng-repeat="message in messages.slice().reverse()"><button type="button" class="close" ng-click="removeNotificationMessage(message)"><span aria-hidden="true">&times;</span> <span class="sr-only">Close</span></button> {{ message.text }}</div>')}]);